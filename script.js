...
function getTime() {
  ...
  if (s == 0) seconds.classList.add('stop-anim');
  else seconds.classList.remove('stop-anim');

  if (m == 0) minutes.classList.add('stop-anim');
  else minutes.classList.remove('stop-anim');
